          ...
          <div class="panel-heading">
                  <div class="form-inline clearfix" role="search">
                      <div class="btn-group order-btn btn-sm" role="group" aria-label="...">
                        <a class="paixu" href="javascript:;">
                          ...
                          <a class="btn-default" href="#">
                              新品
                                                    ...
                                                    <a class="btn-default" href="#">价格</a>
                                                    <a class="btn-default" href="#">
                              销量
                          </a>
                          <a class="no-border btn-default" href="#">
                              评论
                          </a>
                          <!-- <a class="btn  btn-sm btn-default" href="/list.html?orderby=uptime-desc">
                              上架时间
                        ...
                        <button type="button" data-action="/list.html?" onclick="location=$(this).attr('data-action')+'&keyword='+$('#input_keyword').val()" class="btn btn-sm btn-default">确定</button> -->
