                ...
                <div class="layui-form-item" style="margin-top:-38px">
                    ...
                    <div class="layui-input-inline" style="width:200px;text-align: left">
                        <select name="fid">
                           ...
                           <?php if(is_array($re)): foreach($re as $key=>$v): ?><option value="<?php echo ($v["tid"]); ?>"><?php echo ($v["tname"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </div>
                ...
                <?php if(is_array($re)): foreach($re as $key=>$v): ?><tr>
                       ...
                       <!--  <td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="删除" href="javascript:;" onclick="cate_del(this,<?php echo ($v["tid"]); ?>)" 
        ...
        <script>
            layui.use(['element','layer','form'], function(){
              ...
              form.on('submit(add)', function(data){
                ...
                $.ajax({
                    type:'get',
                    url:'/zxshop/admin.php/Goods/addType',
            ...
            function cate_del(obj,id){
             ...
             layer.confirm('确认要删除吗？',function(index){
                    ...
                    $.ajax({
                    	type:'get',
                    	url:'/zxshop/admin.php/Goods/cate_del',
                    	data:{tid:id},
                    	success:function(msg){
                            alert(msg);
                    		/*if(msg=="OK")
